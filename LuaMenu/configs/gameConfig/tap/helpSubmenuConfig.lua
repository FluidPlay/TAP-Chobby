...
local communityLines = {
	{
		...
		"Home",
		function ()
			WG.BrowserHandler.OpenUrl("https://www.fluidplay.co/taprime/")
		end
	},
--	{
--		"Community forums.",
...
--	},
	{
		...
		"Youtube",
		function ()
			WG.BrowserHandler.OpenUrl("https://www.youtube.com/channel/UCuHXr3Fj0Cvit5U5YwXXg-A")
		end
	},
	{
		"Discord chat server.",
		"Discord",
		function ()
			WG.BrowserHandler.OpenUrl("https://discord.gg/XhhBaZZ")
		end
	},
	{
		...
		"Credits",
		function ()
			WG.BrowserHandler.OpenUrl("https://www.fluidplay.co/taprime.html")
		end
	},
	{
	...
	},
	{
		...
		"Source",
		function ()
			WG.BrowserHandler.OpenUrl("https://github.com/fluidplay/taprime")
		end
	},
	{
		...
		"Report bug",
		function ()
			WG.BrowserHandler.OpenUrl("https://github.com/fluidplay/taprime/issues/new")
		end
	},
	{
